...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // We are not using storyboard so, we need to manually create navigation controller with rootview controller of the application.
    ...
    navController.navigationBar.tintColor = [UIColor bottleGreenColorFromHexString];
